...
type ApiServiceClient interface {
	...
	// 同步API资源
	SyncApis(ctx context.Context, in *SyncApisRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	// 查询路由数据
...
func (c *apiServiceClient) SyncApis(ctx context.Context, in *SyncApisRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
type ApiServiceServer interface {
	...
	// 同步API资源
	SyncApis(context.Context, *SyncApisRequest) (*emptypb.Empty, error)
	// 查询路由数据
...
func (UnimplementedApiServiceServer) SyncApis(context.Context, *SyncApisRequest) (*emptypb.Empty, error) {
...
func _ApiService_SyncApis_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApiServiceServer).SyncApis(ctx, req.(*SyncApisRequest))
	}
	return interceptor(ctx, in, info, handler)
}
