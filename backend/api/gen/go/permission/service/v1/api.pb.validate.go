...
// Validate checks the field values on SyncApisRequest with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *SyncApisRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SyncApisRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SyncApisRequestMultiError, or nil if none found.
func (m *SyncApisRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *SyncApisRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetApis() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, SyncApisRequestValidationError{
			...
			if err := v.Validate(); err != nil {
				return SyncApisRequestValidationError{
					field:  fmt.Sprintf("Apis[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return SyncApisRequestMultiError(errors)
	}

	return nil
}

// SyncApisRequestMultiError is an error wrapping multiple validation errors
// returned by SyncApisRequest.ValidateAll() if the designated constraints
// aren't met.
type SyncApisRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SyncApisRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SyncApisRequestMultiError) AllErrors() []error { return m }

// SyncApisRequestValidationError is the validation error returned by
// SyncApisRequest.Validate if the designated constraints aren't met.
type SyncApisRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SyncApisRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SyncApisRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SyncApisRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SyncApisRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SyncApisRequestValidationError) ErrorName() string { return "SyncApisRequestValidationError" }

// Error satisfies the builtin error interface
func (e SyncApisRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSyncApisRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SyncApisRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SyncApisRequestValidationError{}
