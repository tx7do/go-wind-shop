...
const (
	CommentErrorReason_BAD_REQUEST           CommentErrorReason = 0
	CommentErrorReason_UNAUTHORIZED          CommentErrorReason = 100
	CommentErrorReason_FORBIDDEN             CommentErrorReason = 300
	CommentErrorReason_NOT_FOUND             CommentErrorReason = 400
	CommentErrorReason_CONFLICT              CommentErrorReason = 500
	CommentErrorReason_INTERNAL_SERVER_ERROR CommentErrorReason = 600
)
...
const file_comment_service_v1_comment_error_proto_rawDesc = "" +
	"\n" +
	"&comment/service/v1/comment_error.proto\x12\x12comment.service.v1\x1a\x13errors/errors.proto*\xac\x01\n" +
	...
	"\x16com.comment.service.v1B\x11CommentErrorProtoP\x01Z4go-wind-shop/api/gen/go/comment/service/v1;commentpb\xa2\x02\x03CSX\xaa\x02\x12Comment.Service.V1\xca\x02\x12Comment\\Service\\V1\xe2\x02\x1eComment\\Service\\V1\\GPBMetadata\xea\x02\x14Comment::Service::V1b\x06proto3"
