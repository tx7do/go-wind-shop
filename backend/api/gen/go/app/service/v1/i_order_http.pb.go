...
func _OrderService_Count2_HTTP_Handler(srv OrderServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in v1.PagingRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
...
func _OrderService_Get6_HTTP_Handler(srv OrderServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func (c *OrderServiceHTTPClientImpl) Count(ctx context.Context, in *v1.PagingRequest, opts ...http.CallOption) (*v11.CountOrderResponse, error) {
	...
	pattern := "/app/v1/mall/orders/count"
...
func _OrderItemService_Count3_HTTP_Handler(srv OrderItemServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in v1.PagingRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
...
func _OrderItemService_Get7_HTTP_Handler(srv OrderItemServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
