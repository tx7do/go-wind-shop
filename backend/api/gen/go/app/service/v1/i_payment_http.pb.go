...
func RegisterPaymentTransactionServiceHTTPServer(s *http.Server, srv PaymentTransactionServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/app/v1/mall/payment-transactions", _PaymentTransactionService_List8_HTTP_Handler(srv))
...
func _PaymentTransactionService_List8_HTTP_Handler(srv PaymentTransactionServiceHTTPServer) func(ctx http.Context) error {
...
func RegisterPaymentRefundServiceHTTPServer(s *http.Server, srv PaymentRefundServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/app/v1/mall/payment-refunds", _PaymentRefundService_List9_HTTP_Handler(srv))
...
func _PaymentRefundService_List9_HTTP_Handler(srv PaymentRefundServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in v1.PagingRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
