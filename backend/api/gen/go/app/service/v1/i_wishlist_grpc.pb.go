...
const (
	WishlistService_List_FullMethodName   = "/app.service.v1.WishlistService/List"
	WishlistService_Create_FullMethodName = "/app.service.v1.WishlistService/Create"
	WishlistService_Delete_FullMethodName = "/app.service.v1.WishlistService/Delete"
)
...
type WishlistServiceClient interface {
	List(ctx context.Context, in *v1.PagingRequest, opts ...grpc.CallOption) (*v11.ListWishlistResponse, error)
	Create(ctx context.Context, in *v11.CreateWishlistRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	Delete(ctx context.Context, in *v11.DeleteWishlistRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *wishlistServiceClient) List(ctx context.Context, in *v1.PagingRequest, opts ...grpc.CallOption) (*v11.ListWishlistResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v11.ListWishlistResponse)
...
func (c *wishlistServiceClient) Create(ctx context.Context, in *v11.CreateWishlistRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *wishlistServiceClient) Delete(ctx context.Context, in *v11.DeleteWishlistRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
...
func (UnimplementedWishlistServiceServer) List(context.Context, *v1.PagingRequest) (*v11.ListWishlistResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method List not implemented")
}
func (UnimplementedWishlistServiceServer) Create(context.Context, *v11.CreateWishlistRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedWishlistServiceServer) Delete(context.Context, *v11.DeleteWishlistRequest) (*emptypb.Empty, error) {
...
func _WishlistService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v11.CreateWishlistRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WishlistServiceServer).Create(ctx, req.(*v11.CreateWishlistRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _WishlistService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v11.DeleteWishlistRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WishlistServiceServer).Delete(ctx, req.(*v11.DeleteWishlistRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var WishlistService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "app.service.v1.WishlistService",
	...
	Metadata: "app/service/v1/i_wishlist.proto",
}
