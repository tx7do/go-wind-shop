...
func RegisterPositionServiceHTTPServer(s *http.Server, srv PositionServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/positions", _PositionService_List26_HTTP_Handler(srv))
	r.GET("/admin/v1/positions/{id}", _PositionService_Get26_HTTP_Handler(srv))
	r.POST("/admin/v1/positions", _PositionService_Create19_HTTP_Handler(srv))
	r.PUT("/admin/v1/positions/{id}", _PositionService_Update19_HTTP_Handler(srv))
	r.DELETE("/admin/v1/positions/{id}", _PositionService_Delete20_HTTP_Handler(srv))
}

func _PositionService_List26_HTTP_Handler(srv PositionServiceHTTPServer) func(ctx http.Context) error {
...
func _PositionService_Get26_HTTP_Handler(srv PositionServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _PositionService_Create19_HTTP_Handler(srv PositionServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _PositionService_Update19_HTTP_Handler(srv PositionServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _PositionService_Delete20_HTTP_Handler(srv PositionServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
