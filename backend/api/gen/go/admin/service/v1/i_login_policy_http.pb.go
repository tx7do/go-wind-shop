...
func RegisterLoginPolicyServiceHTTPServer(s *http.Server, srv LoginPolicyServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/login-policies", _LoginPolicyService_List13_HTTP_Handler(srv))
	r.GET("/admin/v1/login-policies/{id}", _LoginPolicyService_Get13_HTTP_Handler(srv))
	r.POST("/admin/v1/login-policies", _LoginPolicyService_Create10_HTTP_Handler(srv))
	r.PUT("/admin/v1/login-policies/{id}", _LoginPolicyService_Update9_HTTP_Handler(srv))
	r.DELETE("/admin/v1/login-policies/{id}", _LoginPolicyService_Delete10_HTTP_Handler(srv))
}

func _LoginPolicyService_List13_HTTP_Handler(srv LoginPolicyServiceHTTPServer) func(ctx http.Context) error {
...
func _LoginPolicyService_Get13_HTTP_Handler(srv LoginPolicyServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _LoginPolicyService_Create10_HTTP_Handler(srv LoginPolicyServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _LoginPolicyService_Update9_HTTP_Handler(srv LoginPolicyServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _LoginPolicyService_Delete10_HTTP_Handler(srv LoginPolicyServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
