...
func RegisterTenantServiceHTTPServer(s *http.Server, srv TenantServiceHTTPServer) {
	...
	r.GET("/admin/v1/tenants/{id}", _TenantService_Get40_HTTP_Handler(srv))
	r.POST("/admin/v1/tenants", _TenantService_Create32_HTTP_Handler(srv))
	r.PUT("/admin/v1/tenants/{id}", _TenantService_Update32_HTTP_Handler(srv))
...
func _TenantService_List39_HTTP_Handler(srv TenantServiceHTTPServer) func(ctx http.Context) error {
...
func _TenantService_Get40_HTTP_Handler(srv TenantServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _TenantService_Update32_HTTP_Handler(srv TenantServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
