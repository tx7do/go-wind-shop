...
func RegisterTaskServiceHTTPServer(s *http.Server, srv TaskServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/tasks", _TaskService_List38_HTTP_Handler(srv))
	r.GET("/admin/v1/tasks/type-name/{type_name}", _TaskService_Get38_HTTP_Handler(srv))
	r.GET("/admin/v1/tasks/{id}", _TaskService_Get39_HTTP_Handler(srv))
	r.POST("/admin/v1/tasks", _TaskService_Create30_HTTP_Handler(srv))
	r.PUT("/admin/v1/tasks/{id}", _TaskService_Update31_HTTP_Handler(srv))
	r.DELETE("/admin/v1/tasks/{id}", _TaskService_Delete31_HTTP_Handler(srv))
...
func _TaskService_List38_HTTP_Handler(srv TaskServiceHTTPServer) func(ctx http.Context) error {
...
func _TaskService_Get38_HTTP_Handler(srv TaskServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _TaskService_Get39_HTTP_Handler(srv TaskServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in v11.GetTaskRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
...
func _TaskService_Create30_HTTP_Handler(srv TaskServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _TaskService_Update31_HTTP_Handler(srv TaskServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _TaskService_Delete31_HTTP_Handler(srv TaskServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
