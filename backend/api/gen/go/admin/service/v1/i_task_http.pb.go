...
func RegisterTaskServiceHTTPServer(s *http.Server, srv TaskServiceHTTPServer) {
	...
	r.GET("/admin/v1/tasks/type-name/{type_name}", _TaskService_Get35_HTTP_Handler(srv))
	r.GET("/admin/v1/tasks/{id}", _TaskService_Get36_HTTP_Handler(srv))
	r.POST("/admin/v1/tasks", _TaskService_Create28_HTTP_Handler(srv))
	r.PUT("/admin/v1/tasks/{id}", _TaskService_Update28_HTTP_Handler(srv))
	r.DELETE("/admin/v1/tasks/{id}", _TaskService_Delete29_HTTP_Handler(srv))
...
func _TaskService_Get35_HTTP_Handler(srv TaskServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _TaskService_Create28_HTTP_Handler(srv TaskServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _TaskService_Update28_HTTP_Handler(srv TaskServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _TaskService_Delete29_HTTP_Handler(srv TaskServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
