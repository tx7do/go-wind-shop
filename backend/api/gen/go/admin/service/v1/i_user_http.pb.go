...
func RegisterUserServiceHTTPServer(s *http.Server, srv UserServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/users", _UserService_List34_HTTP_Handler(srv))
	r.GET("/admin/v1/users/username/{username}", _UserService_Get35_HTTP_Handler(srv))
	r.GET("/admin/v1/users/{id}", _UserService_Get36_HTTP_Handler(srv))
	r.POST("/admin/v1/users", _UserService_Create27_HTTP_Handler(srv))
	r.PUT("/admin/v1/users/{id}", _UserService_Update28_HTTP_Handler(srv))
	r.DELETE("/admin/v1/users/username/{username}", _UserService_Delete28_HTTP_Handler(srv))
	r.DELETE("/admin/v1/users/{id}", _UserService_Delete29_HTTP_Handler(srv))
...
func _UserService_List34_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
...
func _UserService_Get35_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _UserService_Get36_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in v11.GetUserRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
...
func _UserService_Create27_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _UserService_Update28_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _UserService_Delete28_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _UserService_Delete29_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in v11.DeleteUserRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
