...
import (
	...
	v11 "go-wind-shop/api/gen/go/identity/service/v1"
...
type UserServiceHTTPServer interface {
	// Create 创建用户
	Create(context.Context, *v11.CreateUserRequest) (*v11.User, error)
	// Delete 删除用户
...
func RegisterUserServiceHTTPServer(s *http.Server, srv UserServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/users", _UserService_List41_HTTP_Handler(srv))
	r.GET("/admin/v1/users/username/{username}", _UserService_Get42_HTTP_Handler(srv))
	r.GET("/admin/v1/users/{id}", _UserService_Get43_HTTP_Handler(srv))
	r.POST("/admin/v1/users", _UserService_Create33_HTTP_Handler(srv))
	r.PUT("/admin/v1/users/{id}", _UserService_Update34_HTTP_Handler(srv))
	r.DELETE("/admin/v1/users/username/{username}", _UserService_Delete34_HTTP_Handler(srv))
	r.DELETE("/admin/v1/users/{id}", _UserService_Delete35_HTTP_Handler(srv))
...
func _UserService_List41_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
...
func _UserService_Get42_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _UserService_Get43_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in v11.GetUserRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
...
func _UserService_Create33_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _UserService_Update34_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _UserService_Delete34_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _UserService_Delete35_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in v11.DeleteUserRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
...
type UserServiceHTTPClient interface {
	// Create 创建用户
	Create(ctx context.Context, req *v11.CreateUserRequest, opts ...http.CallOption) (rsp *v11.User, err error)
	// Delete 删除用户
...
// Create 创建用户
func (c *UserServiceHTTPClientImpl) Create(ctx context.Context, in *v11.CreateUserRequest, opts ...http.CallOption) (*v11.User, error) {
	var out v11.User
