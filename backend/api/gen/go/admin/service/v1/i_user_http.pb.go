...
func RegisterUserServiceHTTPServer(s *http.Server, srv UserServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/users", _UserService_List40_HTTP_Handler(srv))
	r.GET("/admin/v1/users/username/{username}", _UserService_Get41_HTTP_Handler(srv))
	r.GET("/admin/v1/users/{id}", _UserService_Get42_HTTP_Handler(srv))
	r.POST("/admin/v1/users", _UserService_Create33_HTTP_Handler(srv))
	r.PUT("/admin/v1/users/{id}", _UserService_Update33_HTTP_Handler(srv))
...
func _UserService_List40_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
...
func _UserService_Get41_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _UserService_Update33_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
