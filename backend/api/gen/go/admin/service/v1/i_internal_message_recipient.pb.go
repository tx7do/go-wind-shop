...
var File_admin_service_v1_i_internal_message_recipient_proto protoreflect.FileDescriptor
...
const file_admin_service_v1_i_internal_message_recipient_proto_rawDesc = "" +
	...
	"\x16MarkNotificationAsRead\x12:.internal_message.service.v1.MarkNotificationAsReadRequest\x1a\x16.google.protobuf.Empty\"*\x82\xd3\xe4\x93\x02$:\x01*\"\x1f/admin/v1/internal-message/readB\xca\x01\n" +
	"\x14com.admin.service.v1B\x1eIInternalMessageRecipientProtoP\x01Z0go-wind-shop/api/gen/go/admin/service/v1;adminpb\xa2\x02\x03ASX\xaa\x02\x10Admin.Service.V1\xca\x02\x10Admin\\Service\\V1\xe2\x02\x1cAdmin\\Service\\V1\\GPBMetadata\xea\x02\x12Admin::Service::V1b\x06proto3"
...
func init() { file_admin_service_v1_i_internal_message_recipient_proto_init() }
func file_admin_service_v1_i_internal_message_recipient_proto_init() {
	if File_admin_service_v1_i_internal_message_recipient_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_admin_service_v1_i_internal_message_recipient_proto_rawDesc), len(file_admin_service_v1_i_internal_message_recipient_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_admin_service_v1_i_internal_message_recipient_proto_goTypes,
		DependencyIndexes: file_admin_service_v1_i_internal_message_recipient_proto_depIdxs,
	}.Build()
	File_admin_service_v1_i_internal_message_recipient_proto = out.File
	file_admin_service_v1_i_internal_message_recipient_proto_goTypes = nil
	file_admin_service_v1_i_internal_message_recipient_proto_depIdxs = nil
}
