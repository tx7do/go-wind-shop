...
const file_task_service_v1_task_proto_rawDesc = "" +
	...
	"\ttenant_id\x18\x14 \x01(\rB*\xbaG'\x92\x02$租户ID，0代表系统全局角色H\bR\btenantId\x88\x01\x01\x12;\n" +
	"\n" +
	...
	"\vControlTask\x12#.task.service.v1.ControlTaskRequest\x1a\x16.google.protobuf.Empty\"\x00B\xae\x01\n" +
	"\x13com.task.service.v1B\tTaskProtoP\x01Z.go-wind-shop/api/gen/go/task/service/v1;taskpb\xa2\x02\x03TSX\xaa\x02\x0fTask.Service.V1\xca\x02\x0fTask\\Service\\V1\xe2\x02\x1bTask\\Service\\V1\\GPBMetadata\xea\x02\x11Task::Service::V1b\x06proto3"
