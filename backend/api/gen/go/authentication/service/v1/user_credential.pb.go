...
type DeleteUserCredentialRequest struct {
	...
	//	*DeleteUserCredentialRequest_UserId
...
func (x *DeleteUserCredentialRequest) GetUserId() uint32 {
	if x != nil {
		if x, ok := x.QueryBy.(*DeleteUserCredentialRequest_UserId); ok {
			return x.UserId
		}
	}
	return 0
...
type DeleteUserCredentialRequest_UserId struct {
	UserId uint32 `protobuf:"varint,2,opt,name=user_id,json=userId,proto3,oneof"` // 用户ID
}

func (*DeleteUserCredentialRequest_Id) isDeleteUserCredentialRequest_QueryBy() {}

func (*DeleteUserCredentialRequest_UserId) isDeleteUserCredentialRequest_QueryBy() {}
...
const file_authentication_service_v1_user_credential_proto_rawDesc = "" +
	"\n" +
	"/authentication/service/v1/user_credential.proto\x12\x19authentication.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1epagination/v1/pagination.proto\"\xb3\x18\n" +
	...
	"R\x11providerAccountId\x88\x01\x01\x12;\n" +
	"\n" +
	"created_by\x18d \x01(\rB\x17\xbaG\x14\x92\x02\x11创建者用户IDH\vR\tcreatedBy\x88\x01\x01\x12;\n" +
	"\n" +
	"updated_by\x18e \x01(\rB\x17\xbaG\x14\x92\x02\x11更新者用户IDH\fR\tupdatedBy\x88\x01\x01\x12S\n" +
	"\n" +
	...
	"\x04data\x18\x01 \x01(\v2).authentication.service.v1.UserCredentialR\x04data\"t\n" +
	"\x1bDeleteUserCredentialRequest\x12\x1c\n" +
	"\x02id\x18\x01 \x01(\rB\n" +
	"\xbaG\a\x18\x01\x92\x02\x02IDH\x00R\x02id\x12+\n" +
	"\auser_id\x18\x02 \x01(\rB\x10\xbaG\r\x18\x01\x92\x02\b用户IDH\x00R\x06userIdB\n" +
	"\n" +
	"\bquery_by\"\xcb\x01\n" +
	...
	"\x0fResetCredential\x121.authentication.service.v1.ResetCredentialRequest\x1a\x16.google.protobuf.Empty\"\x00B\xfe\x01\n" +
	"\x1dcom.authentication.service.v1B\x13UserCredentialProtoP\x01ZBgo-wind-shop/api/gen/go/authentication/service/v1;authenticationpb\xa2\x02\x03ASX\xaa\x02\x19Authentication.Service.V1\xca\x02\x19Authentication\\Service\\V1\xe2\x02%Authentication\\Service\\V1\\GPBMetadata\xea\x02\x1bAuthentication::Service::V1b\x06proto3"
...
func file_authentication_service_v1_user_credential_proto_init() {
	...
	file_authentication_service_v1_user_credential_proto_msgTypes[4].OneofWrappers = []any{
		...
		(*DeleteUserCredentialRequest_UserId)(nil),
	}
