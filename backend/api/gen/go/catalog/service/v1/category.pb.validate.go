...
// Validate checks the field values on BatchCreateCategoriesRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *BatchCreateCategoriesRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on BatchCreateCategoriesRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// BatchCreateCategoriesRequestMultiError, or nil if none found.
func (m *BatchCreateCategoriesRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *BatchCreateCategoriesRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	for idx, item := range m.GetItems() {
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, BatchCreateCategoriesRequestValidationError{
						field:  fmt.Sprintf("Items[%v]", idx),
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return BatchCreateCategoriesRequestValidationError{
					field:  fmt.Sprintf("Items[%v]", idx),
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return BatchCreateCategoriesRequestMultiError(errors)
	}

	return nil
}

// BatchCreateCategoriesRequestMultiError is an error wrapping multiple
// validation errors returned by BatchCreateCategoriesRequest.ValidateAll() if
// the designated constraints aren't met.
type BatchCreateCategoriesRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m BatchCreateCategoriesRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m BatchCreateCategoriesRequestMultiError) AllErrors() []error { return m }

// BatchCreateCategoriesRequestValidationError is the validation error returned
// by BatchCreateCategoriesRequest.Validate if the designated constraints
// aren't met.
type BatchCreateCategoriesRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e BatchCreateCategoriesRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e BatchCreateCategoriesRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e BatchCreateCategoriesRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e BatchCreateCategoriesRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e BatchCreateCategoriesRequestValidationError) ErrorName() string {
	return "BatchCreateCategoriesRequestValidationError"
}

// Error satisfies the builtin error interface
func (e BatchCreateCategoriesRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sBatchCreateCategoriesRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = BatchCreateCategoriesRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = BatchCreateCategoriesRequestValidationError{}

// Validate checks the field values on BatchCreateCategoriesResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *BatchCreateCategoriesResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on BatchCreateCategoriesResponse with
// the rules defined in the proto definition for this message. If any rules
// are violated, the result is a list of violation errors wrapped in
// BatchCreateCategoriesResponseMultiError, or nil if none found.
func (m *BatchCreateCategoriesResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *BatchCreateCategoriesResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return BatchCreateCategoriesResponseMultiError(errors)
	}

	return nil
}

// BatchCreateCategoriesResponseMultiError is an error wrapping multiple
// validation errors returned by BatchCreateCategoriesResponse.ValidateAll()
// if the designated constraints aren't met.
type BatchCreateCategoriesResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m BatchCreateCategoriesResponseMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m BatchCreateCategoriesResponseMultiError) AllErrors() []error { return m }

// BatchCreateCategoriesResponseValidationError is the validation error
// returned by BatchCreateCategoriesResponse.Validate if the designated
// constraints aren't met.
type BatchCreateCategoriesResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e BatchCreateCategoriesResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e BatchCreateCategoriesResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e BatchCreateCategoriesResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e BatchCreateCategoriesResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e BatchCreateCategoriesResponseValidationError) ErrorName() string {
	return "BatchCreateCategoriesResponseValidationError"
}

// Error satisfies the builtin error interface
func (e BatchCreateCategoriesResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sBatchCreateCategoriesResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = BatchCreateCategoriesResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = BatchCreateCategoriesResponseValidationError{}

// Validate checks the field values on CountCategoryResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *CountCategoryResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CountCategoryResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CountCategoryResponseMultiError, or nil if none found.
func (m *CountCategoryResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *CountCategoryResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CountCategoryResponseMultiError(errors)
	}

	return nil
}

// CountCategoryResponseMultiError is an error wrapping multiple validation
// errors returned by CountCategoryResponse.ValidateAll() if the designated
// constraints aren't met.
type CountCategoryResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CountCategoryResponseMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m CountCategoryResponseMultiError) AllErrors() []error { return m }

// CountCategoryResponseValidationError is the validation error returned by
// CountCategoryResponse.Validate if the designated constraints aren't met.
type CountCategoryResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e CountCategoryResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CountCategoryResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CountCategoryResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CountCategoryResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CountCategoryResponseValidationError) ErrorName() string {
	return "CountCategoryResponseValidationError"
}

// Error satisfies the builtin error interface
func (e CountCategoryResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sCountCategoryResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CountCategoryResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CountCategoryResponseValidationError{}
