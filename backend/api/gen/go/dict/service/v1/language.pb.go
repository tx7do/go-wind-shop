...
const file_dict_service_v1_language_proto_rawDesc = "" +
	...
	"\n" +
	"sort_order\x18\a \x01(\rB'\xbaG$\x92\x02!排序顺序，值越小越靠前H\x06R\tsortOrder\x88\x01\x01\x12;\n" +
	"\n" +
	...
	"\x06Delete\x12&.dict.service.v1.DeleteLanguageRequest\x1a\x16.google.protobuf.Empty\"\x00B\xb2\x01\n" +
	"\x13com.dict.service.v1B\rLanguageProtoP\x01Z.go-wind-shop/api/gen/go/dict/service/v1;dictpb\xa2\x02\x03DSX\xaa\x02\x0fDict.Service.V1\xca\x02\x0fDict\\Service\\V1\xe2\x02\x1bDict\\Service\\V1\\GPBMetadata\xea\x02\x11Dict::Service::V1b\x06proto3"
