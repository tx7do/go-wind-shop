...
func (_q *InvoiceQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *InvoiceQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *InvoiceQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *InvoiceQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *InvoiceQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *InvoiceQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *InvoiceQuery) prepareQuery(ctx context.Context) error {
	...
	if invoice.Policy == nil {
		return errors.New("ent: uninitialized invoice.Policy (forgotten import ent/runtime?)")
	}
	if err := invoice.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *InvoiceQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(invoice.Table, invoice.Columns, sqlgraph.NewFieldSpec(invoice.FieldID, field.TypeUint32))
	_spec.From = _q.sql
