...
var schemaGraph = func() *sqlgraph.Schema {
	...
	graph.Nodes[17] = &sqlgraph.Node{
		...
		Type: "Invoice",
		Fields: map[string]*sqlgraph.FieldSpec{
			invoice.FieldCreatedAt:     {Type: field.TypeTime, Column: invoice.FieldCreatedAt},
			invoice.FieldUpdatedAt:     {Type: field.TypeTime, Column: invoice.FieldUpdatedAt},
			invoice.FieldDeletedAt:     {Type: field.TypeTime, Column: invoice.FieldDeletedAt},
			invoice.FieldCreatedBy:     {Type: field.TypeUint32, Column: invoice.FieldCreatedBy},
			invoice.FieldUpdatedBy:     {Type: field.TypeUint32, Column: invoice.FieldUpdatedBy},
			invoice.FieldDeletedBy:     {Type: field.TypeUint32, Column: invoice.FieldDeletedBy},
			invoice.FieldTenantID:      {Type: field.TypeUint32, Column: invoice.FieldTenantID},
			invoice.FieldCurrency:      {Type: field.TypeString, Column: invoice.FieldCurrency},
			invoice.FieldOrderID:       {Type: field.TypeUint32, Column: invoice.FieldOrderID},
			invoice.FieldUserID:        {Type: field.TypeUint32, Column: invoice.FieldUserID},
			invoice.FieldInvoiceNumber: {Type: field.TypeString, Column: invoice.FieldInvoiceNumber},
			invoice.FieldInvoiceType:   {Type: field.TypeEnum, Column: invoice.FieldInvoiceType},
			invoice.FieldStatus:        {Type: field.TypeEnum, Column: invoice.FieldStatus},
			invoice.FieldBuyerName:     {Type: field.TypeString, Column: invoice.FieldBuyerName},
			invoice.FieldBuyerTaxID:    {Type: field.TypeString, Column: invoice.FieldBuyerTaxID},
			invoice.FieldBuyerAddress:  {Type: field.TypeString, Column: invoice.FieldBuyerAddress},
			invoice.FieldBuyerPhone:    {Type: field.TypeString, Column: invoice.FieldBuyerPhone},
	...
	graph.Nodes[27] = &sqlgraph.Node{
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			...
			order.FieldOriginalAmount:  {Type: field.TypeInt64, Column: order.FieldOriginalAmount},
			order.FieldDiscountAmount:  {Type: field.TypeInt64, Column: order.FieldDiscountAmount},
			order.FieldShippingFee:     {Type: field.TypeInt64, Column: order.FieldShippingFee},
			order.FieldTaxAmount:       {Type: field.TypeInt64, Column: order.FieldTaxAmount},
			order.FieldShippingRegion:  {Type: field.TypeString, Column: order.FieldShippingRegion},
	...
	graph.Nodes[49] = &sqlgraph.Node{
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			...
			shipment.FieldUpdatedAt:      {Type: field.TypeTime, Column: shipment.FieldUpdatedAt},
			shipment.FieldDeletedAt:      {Type: field.TypeTime, Column: shipment.FieldDeletedAt},
			shipment.FieldCreatedBy:      {Type: field.TypeUint32, Column: shipment.FieldCreatedBy},
			shipment.FieldUpdatedBy:      {Type: field.TypeUint32, Column: shipment.FieldUpdatedBy},
			shipment.FieldDeletedBy:      {Type: field.TypeUint32, Column: shipment.FieldDeletedBy},
			shipment.FieldTenantID:       {Type: field.TypeUint32, Column: shipment.FieldTenantID},
			shipment.FieldOrderID:        {Type: field.TypeUint32, Column: shipment.FieldOrderID},
			shipment.FieldUserID:         {Type: field.TypeUint32, Column: shipment.FieldUserID},
			shipment.FieldCarrier:        {Type: field.TypeString, Column: shipment.FieldCarrier},
			shipment.FieldTrackingNumber: {Type: field.TypeString, Column: shipment.FieldTrackingNumber},
			shipment.FieldStatus:         {Type: field.TypeEnum, Column: shipment.FieldStatus},
			shipment.FieldTrackingEvents: {Type: field.TypeString, Column: shipment.FieldTrackingEvents},
		},
	}
	graph.Nodes[50] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   shippingaddress.Table,
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			shippingaddress.FieldCreatedAt:      {Type: field.TypeTime, Column: shippingaddress.FieldCreatedAt},
			shippingaddress.FieldUpdatedAt:      {Type: field.TypeTime, Column: shippingaddress.FieldUpdatedAt},
			shippingaddress.FieldDeletedAt:      {Type: field.TypeTime, Column: shippingaddress.FieldDeletedAt},
			shippingaddress.FieldCreatedBy:      {Type: field.TypeUint32, Column: shippingaddress.FieldCreatedBy},
			shippingaddress.FieldUpdatedBy:      {Type: field.TypeUint32, Column: shippingaddress.FieldUpdatedBy},
			shippingaddress.FieldDeletedBy:      {Type: field.TypeUint32, Column: shippingaddress.FieldDeletedBy},
			shippingaddress.FieldTenantID:       {Type: field.TypeUint32, Column: shippingaddress.FieldTenantID},
			shippingaddress.FieldUserID:         {Type: field.TypeUint32, Column: shippingaddress.FieldUserID},
			shippingaddress.FieldRecipientName:  {Type: field.TypeString, Column: shippingaddress.FieldRecipientName},
			shippingaddress.FieldRecipientPhone: {Type: field.TypeString, Column: shippingaddress.FieldRecipientPhone},
			shippingaddress.FieldRegion:         {Type: field.TypeString, Column: shippingaddress.FieldRegion},
			shippingaddress.FieldDetailAddress:  {Type: field.TypeString, Column: shippingaddress.FieldDetailAddress},
			shippingaddress.FieldPostalCode:     {Type: field.TypeString, Column: shippingaddress.FieldPostalCode},
			shippingaddress.FieldTag:            {Type: field.TypeString, Column: shippingaddress.FieldTag},
			shippingaddress.FieldIsDefault:      {Type: field.TypeBool, Column: shippingaddress.FieldIsDefault},
		},
	}
	graph.Nodes[51] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			Table:   shippingrate.Table,
			Columns: shippingrate.Columns,
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeUint32,
				Column: shippingrate.FieldID,
			},
		},
		Type: "ShippingRate",
		Fields: map[string]*sqlgraph.FieldSpec{
			shippingrate.FieldCreatedAt:  {Type: field.TypeTime, Column: shippingrate.FieldCreatedAt},
			shippingrate.FieldUpdatedAt:  {Type: field.TypeTime, Column: shippingrate.FieldUpdatedAt},
			shippingrate.FieldDeletedAt:  {Type: field.TypeTime, Column: shippingrate.FieldDeletedAt},
			shippingrate.FieldCreatedBy:  {Type: field.TypeUint32, Column: shippingrate.FieldCreatedBy},
			shippingrate.FieldUpdatedBy:  {Type: field.TypeUint32, Column: shippingrate.FieldUpdatedBy},
			shippingrate.FieldDeletedBy:  {Type: field.TypeUint32, Column: shippingrate.FieldDeletedBy},
			shippingrate.FieldTenantID:   {Type: field.TypeUint32, Column: shippingrate.FieldTenantID},
			shippingrate.FieldCurrency:   {Type: field.TypeString, Column: shippingrate.FieldCurrency},
			shippingrate.FieldRegion:     {Type: field.TypeString, Column: shippingrate.FieldRegion},
			shippingrate.FieldBaseFee:    {Type: field.TypeInt64, Column: shippingrate.FieldBaseFee},
			shippingrate.FieldPerUnitFee: {Type: field.TypeInt64, Column: shippingrate.FieldPerUnitFee},
			shippingrate.FieldStatus:     {Type: field.TypeEnum, Column: shippingrate.FieldStatus},
		},
	}
	...
	graph.Nodes[57] = &sqlgraph.Node{
		NodeSpec: sqlgraph.NodeSpec{
			...
			ID: &sqlgraph.FieldSpec{
				Type:   field.TypeUint32,
				Column: taxrate.FieldID,
			},
		},
		Type: "TaxRate",
		Fields: map[string]*sqlgraph.FieldSpec{
			taxrate.FieldCreatedAt: {Type: field.TypeTime, Column: taxrate.FieldCreatedAt},
			taxrate.FieldUpdatedAt: {Type: field.TypeTime, Column: taxrate.FieldUpdatedAt},
			taxrate.FieldDeletedAt: {Type: field.TypeTime, Column: taxrate.FieldDeletedAt},
			taxrate.FieldCreatedBy: {Type: field.TypeUint32, Column: taxrate.FieldCreatedBy},
			taxrate.FieldUpdatedBy: {Type: field.TypeUint32, Column: taxrate.FieldUpdatedBy},
			taxrate.FieldDeletedBy: {Type: field.TypeUint32, Column: taxrate.FieldDeletedBy},
			taxrate.FieldTenantID:  {Type: field.TypeUint32, Column: taxrate.FieldTenantID},
			taxrate.FieldCurrency:  {Type: field.TypeString, Column: taxrate.FieldCurrency},
			taxrate.FieldRegion:    {Type: field.TypeString, Column: taxrate.FieldRegion},
			taxrate.FieldTaxRate:   {Type: field.TypeInt32, Column: taxrate.FieldTaxRate},
	...
	graph.Nodes[60] = &sqlgraph.Node{
		...
		Type: "UserCoupon",
		Fields: map[string]*sqlgraph.FieldSpec{
			usercoupon.FieldCreatedAt:             {Type: field.TypeTime, Column: usercoupon.FieldCreatedAt},
			usercoupon.FieldUpdatedAt:             {Type: field.TypeTime, Column: usercoupon.FieldUpdatedAt},
			usercoupon.FieldDeletedAt:             {Type: field.TypeTime, Column: usercoupon.FieldDeletedAt},
			usercoupon.FieldCreatedBy:             {Type: field.TypeUint32, Column: usercoupon.FieldCreatedBy},
			usercoupon.FieldUpdatedBy:             {Type: field.TypeUint32, Column: usercoupon.FieldUpdatedBy},
			usercoupon.FieldDeletedBy:             {Type: field.TypeUint32, Column: usercoupon.FieldDeletedBy},
			usercoupon.FieldTenantID:              {Type: field.TypeUint32, Column: usercoupon.FieldTenantID},
			usercoupon.FieldUserID:                {Type: field.TypeUint32, Column: usercoupon.FieldUserID},
			usercoupon.FieldCouponTemplateID:      {Type: field.TypeUint32, Column: usercoupon.FieldCouponTemplateID},
			usercoupon.FieldStatus:                {Type: field.TypeEnum, Column: usercoupon.FieldStatus},
			usercoupon.FieldRedeemedAt:            {Type: field.TypeTime, Column: usercoupon.FieldRedeemedAt},
			usercoupon.FieldRedeemedOrderID:       {Type: field.TypeUint32, Column: usercoupon.FieldRedeemedOrderID},
...
// addPredicate implements the predicateAdder interface.
func (_q *CouponTemplateQuery) addPredicate(pred func(s *sql.Selector)) {
	_q.predicates = append(_q.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the CouponTemplateQuery builder.
func (_q *CouponTemplateQuery) Filter() *CouponTemplateFilter {
	return &CouponTemplateFilter{config: _q.config, predicateAdder: _q}
}
...
// WhereID applies the entql uint32 predicate on the id field.
func (f *CouponTemplateFilter) WhereID(p entql.Uint32P) {
...
// WhereDeletedAt applies the entql time.Time predicate on the deleted_at field.
func (f *CouponTemplateFilter) WhereDeletedAt(p entql.TimeP) {
	f.Where(p.Field(coupontemplate.FieldDeletedAt))
}

// WhereCreatedBy applies the entql uint32 predicate on the created_by field.
func (f *CouponTemplateFilter) WhereCreatedBy(p entql.Uint32P) {
	f.Where(p.Field(coupontemplate.FieldCreatedBy))
}

// WhereUpdatedBy applies the entql uint32 predicate on the updated_by field.
func (f *CouponTemplateFilter) WhereUpdatedBy(p entql.Uint32P) {
	f.Where(p.Field(coupontemplate.FieldUpdatedBy))
}

// WhereDeletedBy applies the entql uint32 predicate on the deleted_by field.
func (f *CouponTemplateFilter) WhereDeletedBy(p entql.Uint32P) {
	f.Where(p.Field(coupontemplate.FieldDeletedBy))
}

// WhereTenantID applies the entql uint32 predicate on the tenant_id field.
func (f *CouponTemplateFilter) WhereTenantID(p entql.Uint32P) {
	f.Where(p.Field(coupontemplate.FieldTenantID))
}

// WhereCurrency applies the entql string predicate on the currency field.
func (f *CouponTemplateFilter) WhereCurrency(p entql.StringP) {
	f.Where(p.Field(coupontemplate.FieldCurrency))
}

// WhereDiscountType applies the entql string predicate on the discount_type field.
func (f *CouponTemplateFilter) WhereDiscountType(p entql.StringP) {
	f.Where(p.Field(coupontemplate.FieldDiscountType))
}

// WhereDiscountValue applies the entql int64 predicate on the discount_value field.
func (f *CouponTemplateFilter) WhereDiscountValue(p entql.Int64P) {
	f.Where(p.Field(coupontemplate.FieldDiscountValue))
}

// WhereDiscountPercentage applies the entql int32 predicate on the discount_percentage field.
func (f *CouponTemplateFilter) WhereDiscountPercentage(p entql.Int32P) {
	f.Where(p.Field(coupontemplate.FieldDiscountPercentage))
}

// WhereValidFrom applies the entql time.Time predicate on the valid_from field.
func (f *CouponTemplateFilter) WhereValidFrom(p entql.TimeP) {
	f.Where(p.Field(coupontemplate.FieldValidFrom))
}

// WhereValidUntil applies the entql time.Time predicate on the valid_until field.
func (f *CouponTemplateFilter) WhereValidUntil(p entql.TimeP) {
	f.Where(p.Field(coupontemplate.FieldValidUntil))
}
...
func (f *CouponTemplateFilter) WhereRedeemedCount(p entql.Int32P) {
	f.Where(p.Field(coupontemplate.FieldRedeemedCount))
}
...
// addPredicate implements the predicateAdder interface.
func (_q *InvoiceQuery) addPredicate(pred func(s *sql.Selector)) {
	_q.predicates = append(_q.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the InvoiceQuery builder.
func (_q *InvoiceQuery) Filter() *InvoiceFilter {
	return &InvoiceFilter{config: _q.config, predicateAdder: _q}
}
...
// WhereID applies the entql uint32 predicate on the id field.
func (f *InvoiceFilter) WhereID(p entql.Uint32P) {
	f.Where(p.Field(invoice.FieldID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *InvoiceFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(invoice.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *InvoiceFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(invoice.FieldUpdatedAt))
}

// WhereDeletedAt applies the entql time.Time predicate on the deleted_at field.
func (f *InvoiceFilter) WhereDeletedAt(p entql.TimeP) {
	f.Where(p.Field(invoice.FieldDeletedAt))
}

// WhereCreatedBy applies the entql uint32 predicate on the created_by field.
func (f *InvoiceFilter) WhereCreatedBy(p entql.Uint32P) {
	f.Where(p.Field(invoice.FieldCreatedBy))
}

// WhereUpdatedBy applies the entql uint32 predicate on the updated_by field.
func (f *InvoiceFilter) WhereUpdatedBy(p entql.Uint32P) {
	f.Where(p.Field(invoice.FieldUpdatedBy))
}

// WhereDeletedBy applies the entql uint32 predicate on the deleted_by field.
func (f *InvoiceFilter) WhereDeletedBy(p entql.Uint32P) {
	f.Where(p.Field(invoice.FieldDeletedBy))
}

// WhereTenantID applies the entql uint32 predicate on the tenant_id field.
func (f *InvoiceFilter) WhereTenantID(p entql.Uint32P) {
...
func (f *InvoiceFilter) WhereOrderID(p entql.Uint32P) {
	f.Where(p.Field(invoice.FieldOrderID))
}

// WhereUserID applies the entql uint32 predicate on the user_id field.
func (f *InvoiceFilter) WhereUserID(p entql.Uint32P) {
	f.Where(p.Field(invoice.FieldUserID))
}

// WhereInvoiceNumber applies the entql string predicate on the invoice_number field.
func (f *InvoiceFilter) WhereInvoiceNumber(p entql.StringP) {
	f.Where(p.Field(invoice.FieldInvoiceNumber))
}

// WhereInvoiceType applies the entql string predicate on the invoice_type field.
func (f *InvoiceFilter) WhereInvoiceType(p entql.StringP) {
	f.Where(p.Field(invoice.FieldInvoiceType))
}
...
// WhereBuyerName applies the entql string predicate on the buyer_name field.
func (f *InvoiceFilter) WhereBuyerName(p entql.StringP) {
	f.Where(p.Field(invoice.FieldBuyerName))
}

// WhereBuyerTaxID applies the entql string predicate on the buyer_tax_id field.
func (f *InvoiceFilter) WhereBuyerTaxID(p entql.StringP) {
	f.Where(p.Field(invoice.FieldBuyerTaxID))
}

// WhereBuyerAddress applies the entql string predicate on the buyer_address field.
func (f *InvoiceFilter) WhereBuyerAddress(p entql.StringP) {
	f.Where(p.Field(invoice.FieldBuyerAddress))
}

// WhereBuyerPhone applies the entql string predicate on the buyer_phone field.
func (f *InvoiceFilter) WhereBuyerPhone(p entql.StringP) {
	f.Where(p.Field(invoice.FieldBuyerPhone))
}
...
// WhereOriginalAmount applies the entql int64 predicate on the original_amount field.
func (f *OrderFilter) WhereOriginalAmount(p entql.Int64P) {
	f.Where(p.Field(order.FieldOriginalAmount))
}

// WhereDiscountAmount applies the entql int64 predicate on the discount_amount field.
func (f *OrderFilter) WhereDiscountAmount(p entql.Int64P) {
	f.Where(p.Field(order.FieldDiscountAmount))
}

// WhereShippingFee applies the entql int64 predicate on the shipping_fee field.
func (f *OrderFilter) WhereShippingFee(p entql.Int64P) {
	f.Where(p.Field(order.FieldShippingFee))
}

// WhereTaxAmount applies the entql int64 predicate on the tax_amount field.
func (f *OrderFilter) WhereTaxAmount(p entql.Int64P) {
	f.Where(p.Field(order.FieldTaxAmount))
}

// WhereShippingRegion applies the entql string predicate on the shipping_region field.
func (f *OrderFilter) WhereShippingRegion(p entql.StringP) {
	f.Where(p.Field(order.FieldShippingRegion))
}
...
// addPredicate implements the predicateAdder interface.
func (_q *ShipmentQuery) addPredicate(pred func(s *sql.Selector)) {
	_q.predicates = append(_q.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the ShipmentQuery builder.
func (_q *ShipmentQuery) Filter() *ShipmentFilter {
	return &ShipmentFilter{config: _q.config, predicateAdder: _q}
}
...
// WhereID applies the entql uint32 predicate on the id field.
func (f *ShipmentFilter) WhereID(p entql.Uint32P) {
...
// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *ShipmentFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(shipment.FieldUpdatedAt))
}

// WhereDeletedAt applies the entql time.Time predicate on the deleted_at field.
func (f *ShipmentFilter) WhereDeletedAt(p entql.TimeP) {
	f.Where(p.Field(shipment.FieldDeletedAt))
}

// WhereCreatedBy applies the entql uint32 predicate on the created_by field.
func (f *ShipmentFilter) WhereCreatedBy(p entql.Uint32P) {
	f.Where(p.Field(shipment.FieldCreatedBy))
}

// WhereUpdatedBy applies the entql uint32 predicate on the updated_by field.
func (f *ShipmentFilter) WhereUpdatedBy(p entql.Uint32P) {
	f.Where(p.Field(shipment.FieldUpdatedBy))
}

// WhereDeletedBy applies the entql uint32 predicate on the deleted_by field.
func (f *ShipmentFilter) WhereDeletedBy(p entql.Uint32P) {
	f.Where(p.Field(shipment.FieldDeletedBy))
}

// WhereTenantID applies the entql uint32 predicate on the tenant_id field.
func (f *ShipmentFilter) WhereTenantID(p entql.Uint32P) {
	f.Where(p.Field(shipment.FieldTenantID))
}

// WhereOrderID applies the entql uint32 predicate on the order_id field.
func (f *ShipmentFilter) WhereOrderID(p entql.Uint32P) {
	f.Where(p.Field(shipment.FieldOrderID))
}

// WhereUserID applies the entql uint32 predicate on the user_id field.
func (f *ShipmentFilter) WhereUserID(p entql.Uint32P) {
	f.Where(p.Field(shipment.FieldUserID))
}

// WhereCarrier applies the entql string predicate on the carrier field.
func (f *ShipmentFilter) WhereCarrier(p entql.StringP) {
	f.Where(p.Field(shipment.FieldCarrier))
}

// WhereTrackingNumber applies the entql string predicate on the tracking_number field.
func (f *ShipmentFilter) WhereTrackingNumber(p entql.StringP) {
	f.Where(p.Field(shipment.FieldTrackingNumber))
}
...
// WhereTrackingEvents applies the entql string predicate on the tracking_events field.
func (f *ShipmentFilter) WhereTrackingEvents(p entql.StringP) {
	f.Where(p.Field(shipment.FieldTrackingEvents))
}

// addPredicate implements the predicateAdder interface.
func (_q *ShippingAddressQuery) addPredicate(pred func(s *sql.Selector)) {
	_q.predicates = append(_q.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the ShippingAddressQuery builder.
func (_q *ShippingAddressQuery) Filter() *ShippingAddressFilter {
	return &ShippingAddressFilter{config: _q.config, predicateAdder: _q}
}

// addPredicate implements the predicateAdder interface.
func (m *ShippingAddressMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the ShippingAddressMutation builder.
func (m *ShippingAddressMutation) Filter() *ShippingAddressFilter {
	return &ShippingAddressFilter{config: m.config, predicateAdder: m}
}

// ShippingAddressFilter provides a generic filtering capability at runtime for ShippingAddressQuery.
type ShippingAddressFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *ShippingAddressFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql uint32 predicate on the id field.
func (f *ShippingAddressFilter) WhereID(p entql.Uint32P) {
	f.Where(p.Field(shippingaddress.FieldID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *ShippingAddressFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(shippingaddress.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *ShippingAddressFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(shippingaddress.FieldUpdatedAt))
}

// WhereDeletedAt applies the entql time.Time predicate on the deleted_at field.
func (f *ShippingAddressFilter) WhereDeletedAt(p entql.TimeP) {
	f.Where(p.Field(shippingaddress.FieldDeletedAt))
}

// WhereCreatedBy applies the entql uint32 predicate on the created_by field.
func (f *ShippingAddressFilter) WhereCreatedBy(p entql.Uint32P) {
	f.Where(p.Field(shippingaddress.FieldCreatedBy))
}

// WhereUpdatedBy applies the entql uint32 predicate on the updated_by field.
func (f *ShippingAddressFilter) WhereUpdatedBy(p entql.Uint32P) {
	f.Where(p.Field(shippingaddress.FieldUpdatedBy))
}

// WhereDeletedBy applies the entql uint32 predicate on the deleted_by field.
func (f *ShippingAddressFilter) WhereDeletedBy(p entql.Uint32P) {
	f.Where(p.Field(shippingaddress.FieldDeletedBy))
}

// WhereTenantID applies the entql uint32 predicate on the tenant_id field.
func (f *ShippingAddressFilter) WhereTenantID(p entql.Uint32P) {
	f.Where(p.Field(shippingaddress.FieldTenantID))
}

// WhereUserID applies the entql uint32 predicate on the user_id field.
func (f *ShippingAddressFilter) WhereUserID(p entql.Uint32P) {
	f.Where(p.Field(shippingaddress.FieldUserID))
}

// WhereRecipientName applies the entql string predicate on the recipient_name field.
func (f *ShippingAddressFilter) WhereRecipientName(p entql.StringP) {
	f.Where(p.Field(shippingaddress.FieldRecipientName))
}

// WhereRecipientPhone applies the entql string predicate on the recipient_phone field.
func (f *ShippingAddressFilter) WhereRecipientPhone(p entql.StringP) {
	f.Where(p.Field(shippingaddress.FieldRecipientPhone))
}

// WhereRegion applies the entql string predicate on the region field.
func (f *ShippingAddressFilter) WhereRegion(p entql.StringP) {
	f.Where(p.Field(shippingaddress.FieldRegion))
}

// WhereDetailAddress applies the entql string predicate on the detail_address field.
func (f *ShippingAddressFilter) WhereDetailAddress(p entql.StringP) {
	f.Where(p.Field(shippingaddress.FieldDetailAddress))
}

// WherePostalCode applies the entql string predicate on the postal_code field.
func (f *ShippingAddressFilter) WherePostalCode(p entql.StringP) {
	f.Where(p.Field(shippingaddress.FieldPostalCode))
}

// WhereTag applies the entql string predicate on the tag field.
func (f *ShippingAddressFilter) WhereTag(p entql.StringP) {
	f.Where(p.Field(shippingaddress.FieldTag))
}

// WhereIsDefault applies the entql bool predicate on the is_default field.
func (f *ShippingAddressFilter) WhereIsDefault(p entql.BoolP) {
	f.Where(p.Field(shippingaddress.FieldIsDefault))
}

// addPredicate implements the predicateAdder interface.
func (_q *ShippingRateQuery) addPredicate(pred func(s *sql.Selector)) {
	_q.predicates = append(_q.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the ShippingRateQuery builder.
func (_q *ShippingRateQuery) Filter() *ShippingRateFilter {
	return &ShippingRateFilter{config: _q.config, predicateAdder: _q}
}

// addPredicate implements the predicateAdder interface.
func (m *ShippingRateMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the ShippingRateMutation builder.
func (m *ShippingRateMutation) Filter() *ShippingRateFilter {
	return &ShippingRateFilter{config: m.config, predicateAdder: m}
}

// ShippingRateFilter provides a generic filtering capability at runtime for ShippingRateQuery.
type ShippingRateFilter struct {
	predicateAdder
	config
}

// Where applies the entql predicate on the query filter.
func (f *ShippingRateFilter) Where(p entql.P) {
	f.addPredicate(func(s *sql.Selector) {
...
// WhereID applies the entql uint32 predicate on the id field.
func (f *ShippingRateFilter) WhereID(p entql.Uint32P) {
	f.Where(p.Field(shippingrate.FieldID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *ShippingRateFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(shippingrate.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *ShippingRateFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(shippingrate.FieldUpdatedAt))
}

// WhereDeletedAt applies the entql time.Time predicate on the deleted_at field.
func (f *ShippingRateFilter) WhereDeletedAt(p entql.TimeP) {
	f.Where(p.Field(shippingrate.FieldDeletedAt))
}

// WhereCreatedBy applies the entql uint32 predicate on the created_by field.
func (f *ShippingRateFilter) WhereCreatedBy(p entql.Uint32P) {
	f.Where(p.Field(shippingrate.FieldCreatedBy))
}

// WhereUpdatedBy applies the entql uint32 predicate on the updated_by field.
func (f *ShippingRateFilter) WhereUpdatedBy(p entql.Uint32P) {
	f.Where(p.Field(shippingrate.FieldUpdatedBy))
}

// WhereDeletedBy applies the entql uint32 predicate on the deleted_by field.
func (f *ShippingRateFilter) WhereDeletedBy(p entql.Uint32P) {
	f.Where(p.Field(shippingrate.FieldDeletedBy))
}

// WhereTenantID applies the entql uint32 predicate on the tenant_id field.
func (f *ShippingRateFilter) WhereTenantID(p entql.Uint32P) {
	f.Where(p.Field(shippingrate.FieldTenantID))
}

// WhereCurrency applies the entql string predicate on the currency field.
func (f *ShippingRateFilter) WhereCurrency(p entql.StringP) {
	f.Where(p.Field(shippingrate.FieldCurrency))
}

// WhereRegion applies the entql string predicate on the region field.
func (f *ShippingRateFilter) WhereRegion(p entql.StringP) {
	f.Where(p.Field(shippingrate.FieldRegion))
}

// WhereBaseFee applies the entql int64 predicate on the base_fee field.
func (f *ShippingRateFilter) WhereBaseFee(p entql.Int64P) {
	f.Where(p.Field(shippingrate.FieldBaseFee))
}

// WherePerUnitFee applies the entql int64 predicate on the per_unit_fee field.
func (f *ShippingRateFilter) WherePerUnitFee(p entql.Int64P) {
	f.Where(p.Field(shippingrate.FieldPerUnitFee))
}

// WhereStatus applies the entql string predicate on the status field.
func (f *ShippingRateFilter) WhereStatus(p entql.StringP) {
	f.Where(p.Field(shippingrate.FieldStatus))
}
...
// addPredicate implements the predicateAdder interface.
func (_q *TaxRateQuery) addPredicate(pred func(s *sql.Selector)) {
	_q.predicates = append(_q.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the TaxRateQuery builder.
func (_q *TaxRateQuery) Filter() *TaxRateFilter {
	return &TaxRateFilter{config: _q.config, predicateAdder: _q}
}

// addPredicate implements the predicateAdder interface.
func (m *TaxRateMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the TaxRateMutation builder.
func (m *TaxRateMutation) Filter() *TaxRateFilter {
	return &TaxRateFilter{config: m.config, predicateAdder: m}
}

// TaxRateFilter provides a generic filtering capability at runtime for TaxRateQuery.
...
// WhereID applies the entql uint32 predicate on the id field.
func (f *TaxRateFilter) WhereID(p entql.Uint32P) {
	f.Where(p.Field(taxrate.FieldID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *TaxRateFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(taxrate.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *TaxRateFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(taxrate.FieldUpdatedAt))
}

// WhereDeletedAt applies the entql time.Time predicate on the deleted_at field.
func (f *TaxRateFilter) WhereDeletedAt(p entql.TimeP) {
	f.Where(p.Field(taxrate.FieldDeletedAt))
}

// WhereCreatedBy applies the entql uint32 predicate on the created_by field.
func (f *TaxRateFilter) WhereCreatedBy(p entql.Uint32P) {
	f.Where(p.Field(taxrate.FieldCreatedBy))
}

// WhereUpdatedBy applies the entql uint32 predicate on the updated_by field.
func (f *TaxRateFilter) WhereUpdatedBy(p entql.Uint32P) {
	f.Where(p.Field(taxrate.FieldUpdatedBy))
}

// WhereDeletedBy applies the entql uint32 predicate on the deleted_by field.
func (f *TaxRateFilter) WhereDeletedBy(p entql.Uint32P) {
	f.Where(p.Field(taxrate.FieldDeletedBy))
}

// WhereTenantID applies the entql uint32 predicate on the tenant_id field.
func (f *TaxRateFilter) WhereTenantID(p entql.Uint32P) {
	f.Where(p.Field(taxrate.FieldTenantID))
}

// WhereCurrency applies the entql string predicate on the currency field.
func (f *TaxRateFilter) WhereCurrency(p entql.StringP) {
	f.Where(p.Field(taxrate.FieldCurrency))
}

// WhereRegion applies the entql string predicate on the region field.
func (f *TaxRateFilter) WhereRegion(p entql.StringP) {
	f.Where(p.Field(taxrate.FieldRegion))
}

// WhereTaxRate applies the entql int32 predicate on the tax_rate field.
func (f *TaxRateFilter) WhereTaxRate(p entql.Int32P) {
	f.Where(p.Field(taxrate.FieldTaxRate))
}

// WhereStatus applies the entql string predicate on the status field.
func (f *TaxRateFilter) WhereStatus(p entql.StringP) {
	f.Where(p.Field(taxrate.FieldStatus))
}
...
// addPredicate implements the predicateAdder interface.
func (_q *UserCouponQuery) addPredicate(pred func(s *sql.Selector)) {
	_q.predicates = append(_q.predicates, pred)
}

// Filter returns a Filter implementation to apply filters on the UserCouponQuery builder.
func (_q *UserCouponQuery) Filter() *UserCouponFilter {
	return &UserCouponFilter{config: _q.config, predicateAdder: _q}
}

// addPredicate implements the predicateAdder interface.
func (m *UserCouponMutation) addPredicate(pred func(s *sql.Selector)) {
	m.predicates = append(m.predicates, pred)
}

// Filter returns an entql.Where implementation to apply filters on the UserCouponMutation builder.
func (m *UserCouponMutation) Filter() *UserCouponFilter {
	return &UserCouponFilter{config: m.config, predicateAdder: m}
}

// UserCouponFilter provides a generic filtering capability at runtime for UserCouponQuery.
...
// WhereID applies the entql uint32 predicate on the id field.
func (f *UserCouponFilter) WhereID(p entql.Uint32P) {
	f.Where(p.Field(usercoupon.FieldID))
}

// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *UserCouponFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(usercoupon.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *UserCouponFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(usercoupon.FieldUpdatedAt))
}

// WhereDeletedAt applies the entql time.Time predicate on the deleted_at field.
func (f *UserCouponFilter) WhereDeletedAt(p entql.TimeP) {
	f.Where(p.Field(usercoupon.FieldDeletedAt))
}

// WhereCreatedBy applies the entql uint32 predicate on the created_by field.
func (f *UserCouponFilter) WhereCreatedBy(p entql.Uint32P) {
	f.Where(p.Field(usercoupon.FieldCreatedBy))
}

// WhereUpdatedBy applies the entql uint32 predicate on the updated_by field.
func (f *UserCouponFilter) WhereUpdatedBy(p entql.Uint32P) {
	f.Where(p.Field(usercoupon.FieldUpdatedBy))
}

// WhereDeletedBy applies the entql uint32 predicate on the deleted_by field.
func (f *UserCouponFilter) WhereDeletedBy(p entql.Uint32P) {
	f.Where(p.Field(usercoupon.FieldDeletedBy))
}

// WhereTenantID applies the entql uint32 predicate on the tenant_id field.
func (f *UserCouponFilter) WhereTenantID(p entql.Uint32P) {
	f.Where(p.Field(usercoupon.FieldTenantID))
}

// WhereUserID applies the entql uint32 predicate on the user_id field.
func (f *UserCouponFilter) WhereUserID(p entql.Uint32P) {
	f.Where(p.Field(usercoupon.FieldUserID))
}

// WhereCouponTemplateID applies the entql uint32 predicate on the coupon_template_id field.
func (f *UserCouponFilter) WhereCouponTemplateID(p entql.Uint32P) {
	f.Where(p.Field(usercoupon.FieldCouponTemplateID))
}

// WhereStatus applies the entql string predicate on the status field.
func (f *UserCouponFilter) WhereStatus(p entql.StringP) {
	f.Where(p.Field(usercoupon.FieldStatus))
}

// WhereRedeemedAt applies the entql time.Time predicate on the redeemed_at field.
func (f *UserCouponFilter) WhereRedeemedAt(p entql.TimeP) {
	f.Where(p.Field(usercoupon.FieldRedeemedAt))
}

// WhereRedeemedOrderID applies the entql uint32 predicate on the redeemed_order_id field.
func (f *UserCouponFilter) WhereRedeemedOrderID(p entql.Uint32P) {
	f.Where(p.Field(usercoupon.FieldRedeemedOrderID))
}

// WhereAppliedDiscountAmount applies the entql int64 predicate on the applied_discount_amount field.
func (f *UserCouponFilter) WhereAppliedDiscountAmount(p entql.Int64P) {
	f.Where(p.Field(usercoupon.FieldAppliedDiscountAmount))
}
