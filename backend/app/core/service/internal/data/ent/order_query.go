...
func (_q *OrderQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *OrderQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *OrderQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *OrderQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *OrderQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *OrderQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *OrderQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(order.Table, order.Columns, sqlgraph.NewFieldSpec(order.FieldID, field.TypeUint32))
	_spec.From = _q.sql
