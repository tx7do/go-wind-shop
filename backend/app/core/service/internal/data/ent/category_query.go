...
func (_q *CategoryQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *CategoryQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *CategoryQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *CategoryQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *CategoryQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *CategoryQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CategoryQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(category.Table, category.Columns, sqlgraph.NewFieldSpec(category.FieldID, field.TypeUint32))
	_spec.From = _q.sql
