...
const (
	// Label holds the string label denoting the brandtranslation type in the database.
	Label = "brand_translation"
	...
	// Table holds the table name of the brandtranslation in the database.
	Table = "mall_brand_translations"
)

// Columns holds all SQL columns for brandtranslation fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the BrandTranslation queries.
