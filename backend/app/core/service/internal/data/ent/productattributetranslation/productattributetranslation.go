...
const (
	// Label holds the string label denoting the productattributetranslation type in the database.
	Label = "product_attribute_translation"
	...
	FieldName = "name"
	// Table holds the table name of the productattributetranslation in the database.
	Table = "mall_product_attribute_translations"
)

// Columns holds all SQL columns for productattributetranslation fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the ProductAttributeTranslation queries.
