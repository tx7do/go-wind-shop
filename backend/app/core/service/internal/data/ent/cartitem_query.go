...
func (_q *CartItemQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *CartItemQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *CartItemQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *CartItemQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *CartItemQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *CartItemQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CartItemQuery) prepareQuery(ctx context.Context) error {
	...
	if cartitem.Policy == nil {
		return errors.New("ent: uninitialized cartitem.Policy (forgotten import ent/runtime?)")
	}
	if err := cartitem.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *CartItemQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(cartitem.Table, cartitem.Columns, sqlgraph.NewFieldSpec(cartitem.FieldID, field.TypeUint32))
	_spec.From = _q.sql
