...
func (_q *CommentQuery) QueryChildren() *CommentQuery {
	query := (&CommentClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *CommentQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *CommentQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *CommentQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *CommentQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *CommentQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *CommentQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CommentQuery) WithChildren(opts ...func(*CommentQuery)) *CommentQuery {
	query := (&CommentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *CommentQuery) prepareQuery(ctx context.Context) error {
	...
	if comment.Policy == nil {
		return errors.New("ent: uninitialized comment.Policy (forgotten import ent/runtime?)")
	}
	if err := comment.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
...
func (_q *CommentQuery) loadParent(ctx context.Context, query *CommentQuery, nodes []*Comment, init func(*Comment), assign func(*Comment, *Comment)) error {
	...
	nodeids := make(map[uint32][]*Comment)
	for i := range nodes {
...
func (_q *CommentQuery) loadChildren(ctx context.Context, query *CommentQuery, nodes []*Comment, init func(*Comment), assign func(*Comment, *Comment)) error {
...
func (_q *CommentQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(comment.Table, comment.Columns, sqlgraph.NewFieldSpec(comment.FieldID, field.TypeUint32))
	_spec.From = _q.sql
