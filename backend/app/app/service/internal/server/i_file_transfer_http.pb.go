...
func registerFileTransferServiceHandler(srv *http.Server, svc *service.FileTransferService) {
	...
	r.POST("app/v1/file/upload", _FileTransferService_PostUploadFile_HTTP_Handler(svc))
	r.PUT("app/v1/file/upload", _FileTransferService_PutUploadFile_HTTP_Handler(svc))
