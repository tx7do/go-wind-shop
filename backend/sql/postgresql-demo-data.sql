...
(1011, NOW(), NOW(), 4, 'LINK_TYPE_EXTERNAL', 102, 'GitHub', 'https://github.com/tx7do/go-wind-shop', 0, 'logo-github', '访问我们的GitHub', true, false, 'nav-item footer-nav', '', NULL, 1, 1),
-- ========== 导航组 103（zh-CN 侧边栏导航） ==========
...
(2011, NOW(), NOW(), 4, 'LINK_TYPE_EXTERNAL', 202, 'GitHub', 'https://github.com/tx7do/go-wind-shop', 0, 'logo-github', 'Visit our GitHub', true, false, 'nav-item footer-nav', '', NULL, 1, 1),
...
(
    NOW() - INTERVAL '30 days', NOW(),
    1, 'EDITOR_TYPE_MARKDOWN',
    'POST_STATUS_PUBLISHED', 'gowind-shop-quick-start',
...
(
    ...
    'POST_STATUS_PUBLISHED', 'gowind-shop-performance-optimization',
    false, false, true, true,
    5680, 789, 123,
    1003, '王五', '',
...
## 安装步骤
1. 克隆代码仓库：git clone https://github.com/tx7do/go-wind-shop.git
...
2. 克隆代码：git clone https://github.com/tx7do/go-wind-shop.git
3. 配置数据库连接：修改.env文件
...
(
    ...
    'gowind-shop-performance-optimization',
...
3. 代码：优化Goroutine、JSON序列化、静态资源压缩',
    ...
    'post-tech', '/blog/gowind-shop-performance-optimization',
    3000,
...
## Installation Steps
1. Clone repository: git clone https://github.com/tx7do/go-wind-shop.git
...
> Please change password immediately after first login!',
    ...
    'post-default', '/en/blog/gowind-shop-quick-start',
    2580,
...
2. Clone code: git clone https://github.com/tx7do/go-wind-shop.git
...
3. Code: Goroutine optimization, JSON serialization improvement, static resource compression',
    ...
    'post-tech', '/en/blog/gowind-shop-performance-optimization',
    3000,
